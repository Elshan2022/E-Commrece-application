...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/minimize.png
  AssetGenImage get minimize =>
      const AssetGenImage('assets/icons/minimize.png');
  ...
  List<AssetGenImage> get values =>
      [add, basket, home, menu, minimize, profile];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/welcome1.png
  AssetGenImage get welcome1 =>
      const AssetGenImage('assets/images/welcome1.png');

  /// File path: assets/images/welcome2.png
  AssetGenImage get welcome2 =>
      const AssetGenImage('assets/images/welcome2.png');

  /// File path: assets/images/welcome3.png
  AssetGenImage get welcome3 =>
      const AssetGenImage('assets/images/welcome3.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [facebook, googleLogo, welcome1, welcome2, welcome3];
}

class $AssetsLottieGen {
  const $AssetsLottieGen();

  /// File path: assets/lottie/splashAnimation.json
  String get splashAnimation => 'assets/lottie/splashAnimation.json';
